                        ...
                        <div class="flex-1 flex flex-row-reverse h-full">
                            <div class="sidebar hidden lg:flex w-1/3 flex-2 flex-col pr-6">
                                ...
                                <div class="flex-1 h-full overflow-auto px-2">
                                    <div dir="rtl" class="entry  cursor-pointer transform hover:scale-105 duration-300 transition-transform bg-white mb-4 rounded p-4 flex shadow-md">
                                        <div class="flex-2">
                                    ...
                                    <div  dir="rtl" class="entry cursor-pointer transform hover:scale-105 duration-300 transition-transform bg-white mb-4 rounded p-4 flex shadow-md border-l-4 border-red-500">
                                        <div class="flex-2">
                                            <div class="w-12 h-12 relative">
                                                <img class="w-12 h-12 rounded-full mx-auto" src="/images/1651959757_edait.png" alt="chat-user" />
                                                <span class="absolute w-4 h-4 bg-gray-400 rounded-full right-0 bottom-0 border-2 border-white"></span>
                            ...
                            <div class="chat-area flex-1 flex flex-col">
                                <div class="flex-3" dir="rtl">
                                    <h2 class="text-xl py-1 mb-8 border-b-2 border-gray-200" styly="text-align: center;">  <b> أفنان</b></h2>
                                </div>

...
@section('content')
    ...
    <div class=" d-flex flex-column pt-20">
        <h5 class="my-5 font-xl font-bold">الأعمال الخاصة بي</h5>
        ...
        left: .1rem;">
                <a href="{{ route('userWork') }}" class="mo-btn btn-blue-bg font-md ml-4 "> <i class="fas fa-plus"></i>
                    &nbsp; أضافة </a>
                                    ...
                                    <div class="">
                                        ...
                                        {{-- <article class="filter-group ">
                                            ...
                                            <div class="my-2  " style="margin:4px 14px;">
                                                ...
                                                <select class="selectpicker " value="بالاختيار" name="skills[]" multiple
                                                    aria-label="size 3 select example" data-actions-box="true">
                                        ...
                                        {{-- <article class="filter-group">
                                            ...
                                            <div class="mt-2  " style="margin:0px 14px;">
                                                ...
                                                <select class="selectpicker " value="" name="year" data-actions-box="true"
                                                    style="transform: translate3d(-4px, 212px, 0px);">
                    ...
                    <div class="row ">
                        ...
                        @foreach ($works as $item)
                            <div class="col-lg-6 mb-3 mb-lg-0 my-4">
                                ...
                                <div class="hover hover-1 text-white rounded"><img src="/images/{{ $item->main_image }}"
                                        alt="">

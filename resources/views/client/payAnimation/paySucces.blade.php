    ...
    <div class="flex items-center justify-center h-screen bg-gray-200">
        <div class="bg-white rounded-2xl border shadow-x1 p-10 w-4/12">
          <div class="flex flex-col items-center space-y-4">
            ...
            <lottie-player src="https://assets8.lottiefiles.com/private_files/lf30_ul4trcgf.json"  background="transparent"  speed="1"  style="width: 300px; height: 300px;"  loop  autoplay></lottie-player>
            <button

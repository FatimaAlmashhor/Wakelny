            ...
            <div class="flex flex-col md:flex-row h-full w-full">
                ...
                <div class="w-12/12 md:w-6/12  sm:mt-8 mx-auto">
                    <div class="flex flex-col  items-center  sm:items-start h-full px-5 md:px-24">
                        ...
                        <p class="mt-4">هي أكبر منصة للعمل الحر في العالم العربي
                            <br />
                             وهي منصه ابداعيه تجمع بين اصحاب الاعمال
                             <br /> 
                             والمطور الحر لتسهيل العمل وضمان الحقوق
                             <br />
                              بجوده عاليه وسهوله 
                        </p>
                    </div>
                ...
                <div class=" relative  w-6/12 hidden md:flex  ">
                    <div class="col-lg-4 hero-img" data-aos="" data-aos-delay="">
                        <img src="{{ asset('assets/client/images/hero-img.png') }}" class="img-fluid" alt="" style="width: 100%;
    height: 300px;">
                    </div>
                </div>
            </div>
    ...
    <section class="">
        ...
        <div class="my-16  flex flex-col items-center justify-center">
            ...
            <div class="flex flex-wrap mx-32 p-8">
                ...
                <div class="col-lg-4 col-md-4 col-12  pt-2 bg-white rounded-3xl mx-6 my-4 p-12" style="width: auto;" >
                    <div class="team text-center rounded p-3 py-4">
                        ...
                        <div class="content mt-8">
                            ...
                            <ul class=" flex flex-row items-center justify-center  list-unstyled mt-3 social-icon social mb-0">
                                <li class="list-inline-item mx-4 font-lg "><a href="javascript:void(0)" class="rounded"><i
                                            class="fab fa-github border rounded-md p-1 text-gray" title="Facebook"></i></a></li>
                             
                                <li class="list-inline-item mx-4 font-lg"><a href="javascript:void(0)" class="rounded"><i
                                            class="fab fa-linkedin border rounded-md p-1 text-gray" title="Linkedin"></i></a></li>
                            </ul>
                            <!--end icon-->
                        </div>
                    </div>

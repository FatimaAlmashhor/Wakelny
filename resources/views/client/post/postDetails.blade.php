                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <a type="button" class="fa fa-xmark font-md" data-bs-dismiss="modal"
                                    aria-label="Close"></a>
                            </div>
                            ...
                            <div class="modal-footer">
                                <a href="{{ route('toggle_post', $post_id) }}" class="mo-btn btn-pink-bg pink font-md">تاكيد الحذف</a>
                                            ...
                                            <form id="contactForm" class="row g-3" action='{{ route('comment.add') }}'
                                                ...
                                                <div class="col-sm-4 col-xs-12 pt-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input name="cost" class='appearance-none  border-primary-light-pink border-sm text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-primary-pink' type="number"
                                                            value="{{ old('cost') }}" aria-label="Username"
                                                            aria-describedby="basic-addon1">
                                                        <span class="input-group-text" style="height: 46px;" id="basic-addon1">$</span>
                                                    </div>

                                                    <p class="text-muted ">اختر ميزانية مناسبة</p>
                                                    @error('cost')
                                                ...
                                                <div class="col-sm-4 col-xs-12 pt-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input disabled name="cost_after_taxs" class='appearance-none  border-primary-light-pink border-sm text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-primary-pink'
                                                            type="number" value="{{ old('cost_after_taxs') }}"
                                                            aria-label="Username" aria-describedby="basic-addon1">
                                                        <span class="input-group-text" style="height: 46px;" id="basic-addon1">$</span>
                                                    </div>

                                                    <span class="text-muted">بعد خصم عمولة موقع مستقل</span>
                                                ...
                                                <div class="col-sm-4 col-xs-12 pt-3">
                                                    ...
                                                    <span class="text-muted ">متى تحتاج لتنفيذ مشروعك</span>
                                                    @error('duration')
                                                        <div id='alert ' class="   px-4 alert position-fixed  alert-warning"
                                                            role="alert"
                                                            style="width: fit-content; position: fixed; top: 20% ; right: 0px ; z-index: 9999999">
                                                ...
                                                <div>
                                                    ...
                                                    <textarea class="شppearance-none block w-full bg-sacondary-light-white-pinky border-primary-light-pink border-sm text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-primary-pink" name='message' value="{{ old('message') }}" id="message" type="text"
                                                        ...
                                                        required></textarea>
                                                    <p class="text-muted">أدخل وصفاً مفصلاً لمشروعك وأرفق أمثلة لما تريد
                                                        ان
                                                        أمكن.
                                                    </p>
                                                    @error('message')
                                                ...
                                                <div>
                                                <button class="mo-btn btn-blue-bg float-left font-md" type="submit">انشر الان
                                                    </button>
                                                </div>
                                                                ...
                                                                <div class="card shadow-sm ">
                                                                    <div class="card-body">
                                                                        <form id="contactForm" class="row g-3"
                                                                            ...
                                                                            {{-- duration --}}
                                                                            <div class="col-sm-4 col-xs-12 pt-3">
                                                                                <label class="font-md">المدة المتوقعة للتسليم <em
                                                                                        class="text--danger">*</em>
                                                                                </label>
                                                                                <div class="input-group mb-3">
                                                                            ...
                                                                            <div>
                                                                            <button class="mo-btn btn-blue-bg float-left font-md"
                                                                                    type="submit">حفظ
                                                                                    التعديلات
                                                                                </button>
                                                                            </div>
                                                            ...
                                                            <form action="{{ route('accept-offer') }}"
                                                                ...
                                                                <div class="modal-body ">
                                                                    ...
                                                                    <div class=" row color-black px-3 modal-panel is-show supSection"
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                                                <label class="font-md">المبلغ المتفق عليه </label>
                                                                            ...
                                                                            <div class="col-6">
                                                                                <label class="font-md">المده المتفق عليه </label>
                                                                                <div class="input-group mt-1">
                                                                                    <input name="duration" class='form-control'
                                                                    ...
                                                                    <div class=" modal-footer flex ">
                                                                        <input type="submit" class=" mo-btn font-md"
                                                                            value="قبول العرض">
                                                                        <button type="button" class=" mo-btn btn-blue-rounderd font-md"
